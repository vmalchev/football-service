...
/**
 * @SWG\Definition(definition="v2_AssetDeleteInput")
 */
        ...
        return new Assert\Collection([
            ...
            'entity' => [
                ...
                new Assert\Choice([
                    ...
                    'message' => 'Choose a valid entity type. Options are: ' . implode(", ", AssetEntityType::keys()),
                ]),
            ],
            'entity_id' => [
                new Assert\Length(['max' => 255]),
            ...
            'context_type' => new Assert\Optional([
                ...
                new Assert\Choice([
                    ...
                    'message' => 'Choose a valid entity type. Options are: ' . implode(", ", AssetContextType::keys()),
                ])
            ]),
